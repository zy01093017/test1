...
public interface ActorManager {
     ...
     * Create an actor.
     *
     * @param clazz class of the actor. must have no argument constructor
     * @param name  name to assign to the actor; must be unique for this manager
     * @return the actor
     */
     ...
     * @param clazz   class of the actor. must have no argument constructor
     * @param name    name to assign to the actor; must be unique for this manager
     * @param options dependent parameters
     * @return the actor
     */
