    ...
    protected void loopBody(Message m) {
        ...
        if ("mapReduce".equals(subject)) {
            try {
                ...
                logger.info("mapReduce i={}, c={}, s={}: {}", index, count, partitionSize, p);
                sleep(1000);
            ...
            try {
                ...
                logger.info("createPartition i={}, c={}: {}", index, count, p);
                sleep(500);
            ...
            try {
                ...
                int index = (Integer) oa[1];
                int count = (Integer) oa[2];
                logger.info("mapResponse i={}, c={}: {}", index, count, p);
                sleep(100);
                p.complete();
                // if (p.isSetComplete()) {
            ...
            try {
                ...
                int index = (Integer) oa[1];
                int count = (Integer) oa[2];
                logger.info("reduceWorker i={}, c={}: {}", index, count, p);
                sleep(100);
                if (index >= 0) {
            ...
            try {
                ...
                int index = (Integer) oa[1];
                int count = (Integer) oa[2];
                logger.info("reduceResponse i={}, c={}: {}", index, count, p);
                sleep(100);
                p.complete();
                if (p.isSetComplete()) {
                    if (count > 0) {
            ...
            try {
                ...
                MapReduceParameters p = (MapReduceParameters) oa[0];
                Object res = oa[1];
                logger.info("done {}: {}", res, p);
                sleep(100);
                logger.trace("**** mapReduce done with result {}", res);
            } catch (Exception e) {
                triageException("mapResponseFailed", m, e);
            }
            ...
            try {
                ...
                if (params != null) {
                    ...
                    logger.info("init {}, {}, {} ", values.length, targets.length, clazz);
            ...
            logger.warn("**** MapReduceActor:{} loopBody unexpected subject: {}", getName(), subject);
        }
    }

    protected void triageException(String subject, Message m, Exception e) {
        logger.error("triageException {}: {} {}", subject, m, e.getMessage());
